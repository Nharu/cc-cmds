...
_selected_want="test-gate-oracle.sh test-gate.sh test-liveness-agreement.sh test-lost-dispatch.sh test-run.sh test-snapshot.sh test-stage-supervisor.sh"
