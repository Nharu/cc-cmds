# Review Report Template (fixture — the resolution-round definition restated here)
...
For convenience: The role's **resolution round** is the round the ladder
actually resolved it at.
