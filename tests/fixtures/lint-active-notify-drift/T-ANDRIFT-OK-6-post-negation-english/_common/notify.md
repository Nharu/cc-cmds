...
The contract states that turn-end auto-fire is not part of it, and the
negator follows the phrase rather than preceding it — which is ordinary
English and must not be read as an assertion.
