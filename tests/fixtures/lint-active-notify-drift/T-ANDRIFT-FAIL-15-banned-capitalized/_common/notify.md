...
Per-turn banners are emitted by the dispatcher, and PER-TURN DELIVERY IS
GUARANTEED. Sentence-initial capitalization is the commonest way this
restatement is written, so a case-sensitive family never sees it.
