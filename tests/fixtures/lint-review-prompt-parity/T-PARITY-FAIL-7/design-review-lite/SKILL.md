...
description: T-PARITY-FAIL-7 fixture — lite (Step-8 seed reintroduced on the lite surface only)
---
...
Step 8 seed (lite-only regression): `echo "" > "$INNER_TEMP_DIR/review_proposals.md"`
