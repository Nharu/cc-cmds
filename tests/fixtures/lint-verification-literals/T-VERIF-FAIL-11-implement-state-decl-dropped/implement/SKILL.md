...
The consumer reads the field. The producer authorizes a sub-section rendering and a table rendering; this consumer reads both, and an entry matched by neither is undetermined rather than defaulted.
